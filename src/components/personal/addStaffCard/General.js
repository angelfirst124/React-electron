                ...
                <FormGroup label="İşe Başlama Tarihi">
                    <div className="grid grid-cols-3 gap-1">
                        <div className="flex col-span-2 items-center">
                            <DatePicker autoComplete="off" dateFormat="dd.MM.yyyy" name="sozlesmeBitisTarih" selected={props.formProps.values.iseGirisTarih} onChange={(date) => props.formProps.setFieldValue('iseGirisTarih', date)} className="cs-input pr-8" />
